...
func TestAccDatabase_Local_Basic_Import(t *testing.T) {
...
func TestAccDatabase_Local_Basic_Create(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatabase(t, "local_basic_create", "login", map[string]interface{}{"database_name": "tf_acc_test_db_create"}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDatabaseExists("mssql_database.local_basic_create"),
					resource.TestCheckResourceAttr("mssql_database.local_basic_create", "database_name", "tf_acc_test_db_create"),
					...
					resource.TestCheckResourceAttrSet("mssql_database.local_basic_create", "compatibility_level"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatabase(t, "local_collation_create", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_collation",
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("mssql_database.local_collation_create", "database_name", "tf_acc_test_db_collation"),
...
func TestAccDatabase_Local_Basic_Update_DatabaseName(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		IsUnitTest:        runLocalAccTests,
		ProviderFactories: testAccProviders,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatabase(t, "local_database_name_update", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_database_name1",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDatabaseExists("mssql_database.local_database_name_update",
						Check{"database_name", "==", "tf_acc_test_db_database_name1"},
					),
					resource.TestCheckResourceAttr("mssql_database.local_database_name_update", "database_name", "tf_acc_test_db_database_name1"),
				),
			},
			{
				Config: testAccCheckDatabase(t, "local_database_name_update", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_database_name2",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDatabaseExists("mssql_database.local_database_name_update",
						Check{"database_name", "==", "tf_acc_test_db_database_name2"},
					),
					resource.TestCheckResourceAttr("mssql_database.local_database_name_update", "database_name", "tf_acc_test_db_database_name2"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatabase(t, "local_collation_update", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_coll_update",
					"collation":     "SQL_Latin1_General_CP1_CI_AS",
				}),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccDatabase_Local_Basic_Update_DatabaseName_and_Collation(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		IsUnitTest:        runLocalAccTests,
		ProviderFactories: testAccProviders,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckDatabase(t, "local_db_coll_update", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_and_coll_update1",
					"collation":     "SQL_Latin1_General_CP1_CI_AS",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDatabaseExists("mssql_database.local_db_coll_update",
						Check{"collation", "==", "SQL_Latin1_General_CP1_CI_AS"},
					),
					resource.TestCheckResourceAttr("mssql_database.local_db_coll_update", "collation", "SQL_Latin1_General_CP1_CI_AS"),
				),
			},
			{
				Config: testAccCheckDatabase(t, "local_db_coll_update", "login", map[string]interface{}{
					"database_name": "tf_acc_test_db_and_coll_update2",
					"collation":     "SQL_Latin1_General_CP1_CS_AS",
				}),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDatabaseExists("mssql_database.local_db_coll_update",
					...
					resource.TestCheckResourceAttr("mssql_database.local_db_coll_update", "collation", "SQL_Latin1_General_CP1_CS_AS"),
				),
			},
		},
	})
...
func TestAccDatabase_Azure_Basic_Create_ERROR(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		ProviderFactories: testAccProviders,
		CheckDestroy:      func(state *terraform.State) error { return testAccCheckDatabaseDestroy(state) },
		Steps: []resource.TestStep{
			{
				Config:      testAccCheckDatabase(t, "azure_basic_create", "azure", map[string]interface{}{"database_name": "tf_acc_test_db_create"}),
				ExpectError: regexp.MustCompile("mssql_database is not supported on Azure SQL Database"),
			},
		},
	})
}
...
func testAccCheckDatabaseExists(resource string, checks ...Check) resource.TestCheckFunc {
	return func(state *terraform.State) error {
		...
		if db.DatabaseName != databaseName {
			return fmt.Errorf("expected database name %s, got %s", databaseName, db.DatabaseName)
		}
