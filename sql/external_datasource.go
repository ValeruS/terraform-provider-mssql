...
func (c *Connector) GetExternalDatasource(ctx context.Context, database, datasourcename string) (*model.ExternalDatasource, error) {
	var extds model.ExternalDatasource
...
func (c *Connector) CreateExternalDatasource(ctx context.Context, database, datasourcename, location, credentialname, typedesc, rdatabasename string) error {
...
func (c *Connector) UpdateExternalDatasource(ctx context.Context, database, datasourcename, location, credentialname, rdatabasename string) error {
	cmd := `DECLARE @stmt nvarchar(max)
...
func (c *Connector) DeleteExternalDatasource(ctx context.Context, database, datasourcename string) error {
	cmd := `DECLARE @stmt nvarchar(max)
